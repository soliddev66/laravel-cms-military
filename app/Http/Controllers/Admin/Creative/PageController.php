...
class PageController extends Controller
{
    ...
    public function index()
    {
        ...
        $pages = CreativePage::where('language_id', $language->id)->orderBy('id', 'desc')->get();

        return view('admin.creative.page.index', compact('pages'));
    }
    ...
    {
        return view('admin.creative.page.create');
    }
    ...
    public function store(Request $request)
    {
        // Form validation
        $request->validate([
            'page_title' => 'required|unique:creative_pages',
            'desc' => 'required',
    ...
    {
        // Retrieving models
        $page = CreativePage::find($id);

        return view('admin.creative.page.edit', compact( 'page'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            'page_title'   =>  [
                'required',
                Rule::unique('creative_pages')->ignore($id),
            ],
            'desc' => 'required',
            'breadcrumb_image' => 'mimes:svg,jpeg,jpg,png|max:2048',
            'status' => 'integer|in:0,1',
        ...
        // Update to database
        CreativePage::find($id)->update($input);
