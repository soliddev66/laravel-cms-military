...
class SiteImageController extends Controller
{
    ...
    {
        // Retrieving a model
        $site_image = CreativeSiteImage::first();

        return view('admin.creative.setting.site_image.create', compact('site_image'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // Record to database
        CreativeSiteImage::firstOrCreate([
    ...
    public function update(Request $request, $id)
    {
        ...
        // Get model
        $site_image = CreativeSiteImage::find($id);
        ...
        // Update model
        CreativeSiteImage::find($id)->update($input);
