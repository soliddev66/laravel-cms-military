                       ...
                       <div class="row text-center">
                          @foreach ($sliders as $slider)
                               <div class="col-sm-6 col-xl-3">
                                   <a href="{{ asset('uploads/img/sliders/'.$slider->slider_image) }}" data-lightbox="example-set"><img src="{{ asset('uploads/img/sliders/'.$slider->slider_image) }}" class="img-fluid mb-30" alt="slider image"></a>
                                  <div>
