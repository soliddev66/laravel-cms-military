...
@section('content')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-md-flex justify-content-between align-items-center mb-20">
                        ...
                        <div>
                            <button type="button" class="btn btn-primary mb-3 mr-2" data-toggle="modal" data-target="#contactSectionModal">{{ __('content.section_title') }}</button>
    ...
    <div class="modal fade" id="contactSectionModal" tabindex="-1" role="dialog" aria-labelledby="contactSectionModalLabel" aria-modal="false">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title mt-0 font-16" id="contactModalLabel">{{ __('content.section_title') }}</h5>
