                                                ...
                                                <div class="media">
                                                    @if (!empty($site_image->favicon_image))
                                                        <a  class="d-block mx-auto" href="#" data-toggle="tooltip" data-placement="top" data-original-title="{{ __('content.current_image') }}">
                                                            <img src="{{ asset('uploads/creative/img/general/'.$site_image->favicon_image) }}" alt="favicon image" class="rounded w-25">
                                                        </a>
                                                    @else
                                            ...
                                            <div class="avatar-area text-center">
                                                <div class="media">
                                                    @if (!empty($site_image->admin_logo_image))
                                                        <a  class="d-block mx-auto" href="#" data-toggle="tooltip" data-placement="top" data-original-title="{{ __('content.current_image') }}">
                                                            <img src="{{ asset('uploads/creative/img/general/'.$site_image->admin_logo_image) }}" alt="logo image" class="rounded w-25">
                                                        </a>
                                                    @else
                                                        <a class="d-block mx-auto" href="#" data-toggle="tooltip" data-placement="top" data-original-title="{{ __('content.not_yet_created') }}">
                                                                <img src="{{ asset('uploads/creative/img/dummy/no-image.jpg') }}" alt="no image" class="rounded w-25">
                                            ...
                                            <div class="avatar-area text-center">
                                                <div class="media">
                                                    @if (!empty($site_image->admin_small_logo_image))
                                                        <a  class="d-block mx-auto" href="#" data-toggle="tooltip" data-placement="top" data-original-title="{{ __('content.current_image') }}">
                                                            <img src="{{ asset('uploads/creative/img/general/'.$site_image->admin_small_logo_image) }}" alt="logo image" class="rounded w-25">
                                                        </a>
                                                    @else
                                                       <a class="d-block mx-auto" href="#" data-toggle="tooltip" data-placement="top" data-original-title="{{ __('content.not_yet_created') }}">
                                                                <img src="{{ asset('uploads/creative/img/dummy/no-image.jpg') }}" alt="no image" class="rounded w-25">
                                            ...
                                            <div class="avatar-area text-center">
                                                <div class="media">
                                                    @if (!empty($site_image->site_white_logo_image))
                                                        <a  class="d-block mx-auto" href="#" data-toggle="tooltip" data-placement="top" data-original-title="{{ __('content.current_image') }}">
                                                            <img src="{{ asset('uploads/creative/img/general/'.$site_image->site_white_logo_image) }}" alt="logo image" class="rounded w-25">
                                                        </a>
                                                    @else
                                                       <a class="d-block mx-auto" href="#" data-toggle="tooltip" data-placement="top" data-original-title="{{ __('content.not_yet_created') }}">
                                                                <img src="{{ asset('uploads/creative/img/dummy/no-image.jpg') }}" alt="no image" class="rounded w-25">
                                            ...
                                            <div class="avatar-area text-center">
                                                <div class="media">
                                                    @if (!empty($site_image->site_colored_logo_image))
                                                        <a  class="d-block mx-auto" href="#" data-toggle="tooltip" data-placement="top" data-original-title="{{ __('content.current_image') }}">
                                                            <img src="{{ asset('uploads/creative/img/general/'.$site_image->site_colored_logo_image) }}" alt="logo image" class="rounded w-25">
                                                        </a>
                                                    @else
                                                       <a class="d-block mx-auto" href="#" data-toggle="tooltip" data-placement="top" data-original-title="{{ __('content.not_yet_created') }}">
                                                                <img src="{{ asset('uploads/creative/img/dummy/no-image.jpg') }}" alt="no image" class="rounded w-25">
