            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-md-flex justify-content-between align-items-center mb-20">
                        ...
                        <div>
                            <button type="button" class="btn btn-primary  mb-3 mr-2" data-toggle="modal" data-target="#testimonialSectionModal">{{ __('content.section_title') }}</button>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (!empty($testimonial->testimonial_image))
                                            <img class="image-size img-fluid" src="{{ asset('uploads/creative/img/testimonials/'.$testimonial->testimonial_image) }}" alt="testimonial image">
                                        @else
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @if (isset($testimonial_section))
                        <form action="{{ route('testimonial-section.update', $testimonial_section->id) }}" method="POST" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                ...
                <div class="modal-body">
                    <form action="{{ route('testimonial.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="testimonial_image2">{{ __('content.image') }} ({{ __('content.size') }} 150 x 150) (.svg, .jpg, .jpeg, .png)</label>
