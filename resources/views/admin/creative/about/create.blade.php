                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="top_title" class="form-control" id="top_title" value="{{ $about->top_title }}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="about_image">{{ __('content.image') }} ({{ __('content.size') }} 520 x 610) (.svg, .jpg, .jpeg, .png)</label>
                                                ...
                                                <div class="media">
                                                    @if (!empty($about->about_image))
                                                        <a  class="d-block mx-auto" href="#" data-toggle="tooltip" data-placement="top" data-original-title="{{ __('content.current_image') }}">
                                                            <img src="{{ asset('uploads/creative/img/general/'.$about->about_image) }}" alt="about image" class="rounded w-25">
                                                        </a>
                                                    @else
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                ...
                                                <a href="#" data-toggle="modal" data-target="#deleteModel{{ $info_list->id }}">
