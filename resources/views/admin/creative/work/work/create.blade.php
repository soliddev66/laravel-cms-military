                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="image">{{ __('content.image') }} ({{ __('content.size') }} 600 x 800)(.svg, .png, .jpg, .jpeg)</label>
                                    <input id="image" name="thumbnail_image" type="file" class="form-control-file">
