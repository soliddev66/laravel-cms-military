                            ...
                            <div class="col-md-2">
                                <div class="hiddenradio">
                                    <label>
                                        ...
                                        <img class="img-fluid shadow" src="{{ asset('uploads/img/dummy/demo-1.png') }}" alt="version image">
                                    </label>
                                    <span>{{ __('Static') }}</span>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="hiddenradio">
                                    <label>
                                        ...
                                        <img class="img-fluid shadow" src="{{ asset('uploads/img/dummy/demo-2.png') }}" alt="version image">
                                    </label>
                                    <span>{{ __('Slider') }}</span>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="hiddenradio">
                                    <label>
                                        ...
                                        <img class="img-fluid shadow" src="{{ asset('uploads/img/dummy/demo-3.png') }}" alt="light image">
                                    </label>
                                    <span>{{ __('Video') }}</span>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="hiddenradio">
                                    <label>
                                        ...
                                        <img class="img-fluid shadow" src="{{ asset('uploads/img/dummy/demo-4.png') }}" alt="light image">
                                    </label>
                            ...
                            <div class="col-md-2">
                                <div class="hiddenradio">
                                    <label>
                                        ...
                                        <img class="img-fluid shadow" src="{{ asset('uploads/img/dummy/demo-5.png') }}" alt="light image">
                                    </label>
                            ...
                            <div class="col-md-2">
                                <div class="hiddenradio">
                                    <label>
                                        ...
                                        <img class="img-fluid shadow" src="{{ asset('uploads/img/dummy/demo-6.png') }}" alt="light image">
                                    </label>
                                    <span>{{ __('Glitch') }}</span>
                                </div>
                            </div>
