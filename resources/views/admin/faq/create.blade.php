                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control" id="title" value="{{ $faq_section->title }}">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="faq_image">{{ __('content.image') }} ({{ __('content.size') }} 540 x 540) (.svg, .jpg, .jpeg, .png)</label>
                                        <input type="file" name="faq_image" class="form-control-file" id="faq_image">
                                        <small id="faq_image" class="form-text text-muted">{{ __('content.recommended_size') }}</small>
                                    </div>
                                                    ...
                                                    <div class="media">
                                                        @if (!empty($faq_section->faq_image))
                                                            <a  class="d-block mx-auto" href="#" data-toggle="tooltip" data-placement="top" data-original-title="{{ __('content.current_image') }}">
                                                                <img src="{{ asset('uploads/img/general/'.$faq_section->faq_image) }}" alt="faq image" class="rounded w-25">
                                                            </a>
                                                        @else
                                                            <a  class="d-block mx-auto" href="#" data-toggle="tooltip" data-placement="top" data-original-title="{{ __('content.current_image') }}">
